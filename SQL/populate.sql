...
-- paper_id: 7
CALL createNewPaper('filename7', 'Uppgava hja Per', 230, 50, 'Oli');
-- paper_id: 8
...
-- paper_id: 12
CALL createNewPaper('filename12', 'Dokumentation', 2400, 320, 'Per');
-- paper_id: 13
CALL createNewPaper('filename13', 'Notatir', 76, 50, 'Oli');
-- paper_id: 14
